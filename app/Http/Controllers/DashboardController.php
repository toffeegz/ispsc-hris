...
class DashboardController extends Controller
{
    ...
    public function departmentWiseTardiness()
    {
        ...
        // Set default value for $frequency if null
    ...
    {
        $ipcr_period_id = request()->ipcr_period_id;
        $ipcr_period_id = $ipcr_period_id ?? null;
    ...
    public function ipcrGraph()
    {
        ...
        $department_id = request()->department_id;
        $department_id = $department_id ?? null;
        $results = $this->modelService->ipcrGraph($ipcr_period_id, $department_id);
        return $this->responseService->successResponse($this->name, $results);
    }
